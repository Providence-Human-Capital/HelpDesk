...
export default function general() {
  ...
  const onSubmit = (data) => {
    setLoading(true);
    axios
      .post("http://localhost:8888/general/add", data)
      .then((res) => {
  ...
  return (
    <Container maxW="1100px" mt={1} color={"black"}>
      <VStack spacing={4} align="stretch">
        <Text fontSize={{ md: "3xl", base: "2xl" }} mt={5}>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <FormControl id="lastname">
            ...
            <Input
              ...
              focusBorderColor="lime"
              {...register("lastname", {
                minLength: { value: 4, message: "Your last name is too short" },
              })}
          ...
          <FormControl id="description" mt={4}>
            <FormLabel as="u" color={errors.description ? "red" : "black"}>
              Request Description
            </FormLabel>
            <Textarea
