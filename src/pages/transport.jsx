...
export default function Transport() {
  ...
  const onSubmit = (data) => {
    ...
    setLoading(true);
    axios
      .post("http://localhost:8888/transport/add", data)
      .then((res) => {
        // console.log(res.data)
        toast({
          title: "Your request has been successfully sent",
          description:
            "Please check your emails for further updates on your request",
          status: "success",
          duration: 7000,
          isClosable: true,
          position: "top-right",
      ...
      .catch((err) => {
        ...
        toast({
          ...
          description:
            "There was a problem processing your request, you might need to contact IT",
          status: "error",
          duration: 4000,
          isClosable: true,
          position: "top-right",
        ...
        <VStack mt={5} spacing={4}>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <FormControl id="email" mt={5}>
              <FormLabel as="u" color={errors.email ? "red" : "black"}>
                Email
              </FormLabel>
              <InputGroup>
                <Input
                  ...
                  focusBorderColor="lime"
                  {...register("email", {
                    minLength: { value: 4, message: "Your email is too short" },
                  })}
            ...
            <FormControl id="route" mt={5}>
              <FormLabel as="u" color={errors.route ? "red" : "black"}>
                Route
              </FormLabel>
              ...
              <Flex flexDirection={{ base: "column", md: "row" }}>
                <Input
                  ...
                  focusBorderColor="lime"
                  {...register("start", {
                    minLength: { value: 3, message: "Your route is too short" },
                  })}
            ...
            <FormControl id="purpose" mt={5}>
              ...
              <Textarea
                ...
                focusBorderColor="lime"
                {...register("purpose", {
                  minLength: { value: 4, message: "Your purpose is too short" },
                })}
            ...
            <FormControl id="cargo" mt={5}>
              <FormLabel as="u" color={errors.cargo ? "red" : "black"}>
                Cargo Carried
              </FormLabel>
            ...
            <FormControl id="additional" mt={5}>
              <FormLabel as="u" color={errors.additional ? "red" : "black"}>
